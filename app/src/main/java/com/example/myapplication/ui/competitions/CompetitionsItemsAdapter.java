...
public class CompetitionsItemsAdapter extends RecyclerView.Adapter<CompetitionsItemsAdapter.ViewHolder> {

    private Context context;
    private List<CompetitionDto> competitions;

    public CompetitionsItemsAdapter(Context context, List<CompetitionDto> competitions) {
