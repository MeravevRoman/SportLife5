...
public class TrainTypeAddDialog extends BottomSheetDialogFragment {

    private EditText editTextTrainTypeTitle;
    private Button btnAddTrainType;

    public TrainTypeAddDialog.OnInputListener mOnInputListener;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        btnAddTrainType.setOnClickListener(v -> {
            TrainTypeAddDialog.OnInputListener listener = (TrainTypeAddDialog.OnInputListener) getActivity();
